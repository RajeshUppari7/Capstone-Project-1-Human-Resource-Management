...
public class AdminTest extends BaseClass {
	...
	public void assertCountAndNavigateToAdmin() {
		Assert.assertEquals(adminPage.getCountOfMenuOptions(), 12, "Menu option count not matched.......");
		System.out.println("Menu options count matched!!!!!!!");

		adminPage.clickOnAdmin();
		Assert.assertTrue(driver.getCurrentUrl().contains("admin"), "Admin page not opened");
