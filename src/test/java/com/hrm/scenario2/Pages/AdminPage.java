...
public class AdminPage {
	...
	public int getCountOfMenuOptions() {
		...
		System.out.println("Menu Options count is : " + options.size());
		return options.size();
	}
	...
	public String searchByUserName() {
		String username = ExcelData.getFormattedData("Scenario2", 2, 5);
	...
	public String searchByUserRole() {
		String role = ExcelData.getFormattedData("Scenario2", 2, 7);
	...
	public String searchByUserStatus() {
		String status = ExcelData.getFormattedData("Scenario2", 2, 9);
	...
	public void getRecords() {
		List<WebElement> noOfRecords = driver.findElements(records);
		System.out.println("No of Records are : " + noOfRecords.size());
		for (WebElement i : noOfRecords) {
			System.out.println(i.getText());
		}

	}

	By countText = By.xpath("//span[@class='oxd-text oxd-text--span']");

	public String getCountOfRecords() {
		String count = driver.findElement(countText).getText();
		return count;
	}
	...
	public void selectOption(String text) {
		List<WebElement> userRoleOptions = driver.findElements(dropdownOptions);
