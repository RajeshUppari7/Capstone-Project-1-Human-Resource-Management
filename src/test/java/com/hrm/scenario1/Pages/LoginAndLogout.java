...
import com.hrm.scenario1.Base.BaseClass;
import com.hrm.scenario1.Listeners.ExtentITestNGListener;
import com.hrm.scenario1.Utilities.Utility;
...
public class LoginAndLogout extends BaseClass {
	...
	public void loginWithValidAndInvalidCred(String uid, String psw) throws InterruptedException {
		...
		Thread.sleep(1500);
		System.out.println("Username : " + uid + " & Password : " + psw);
